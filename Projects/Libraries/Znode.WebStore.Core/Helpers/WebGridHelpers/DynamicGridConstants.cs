namespace Znode.Engine.WebStore.Helpers
{
    public struct DynamicGridConstants
    {
        ...
        public const string ColumnListWithNewSesionKey = "ColumnListWithNewSesionKey";
        ...
        public const string CheckboxHtml = "<input type=\"checkbox\" name=\"{1}\" id=\"rowcheck_{0}\" class=\"grid-row-checkbox\">  <label for=\"rowcheck_{0}\" class=\"visuallyhidden lbl padding-8\">Checkbox</label>";
        public const string DeleteHtml = "<a id=\"spanDelete_{3}\" href=\"javascript:void(0);\" class=\"zf-delete active-icon\" title=\"Delete\"  onclick=\"CommonHelper.BindDeleteConfirmDialog('{1}','{2}','{0}')\"></a>";
        public const string EditHtml = "<a href=\"{0}\"  class=\"zf-edit active-icon\" title=\"Edit\"></a>";
        public const string ViewHtml = "<a href=\"{0}\" class=\"zf-view active-icon\" title=\"View\"></a>";
        public const string ManageHtml = "<div>" +
                                            "<a href=\"#\" class='action-link' title='Action Links'>" +
        ...
        public const string CopyHtml = "<a href=\"{0}\" class=\"zf-copy active-icon\" title=\"Copy\"></a>";
        ...
        public const string DisableHtml = "<a id=\"spanDisable_{4}\" title='{5}' href=\"javascript:void(0);\" class=\"zf-{3} active-icon\"  onclick=\"CommonHelper.BindDeleteConfirmDialog('{1}','{2}','{0}')\"></a>";
        public const string IconTrue = "<i class='zf-check-circle'></i>";
        public const string IconFalse = "<i class='zf-close-circle'></i>";
        ...
        public const string BulkAddColumnListSesionKey = "BulkAddColumnList";
        ...
        public const string InlineEditHtml = "<label data-dgview='show' data-columnname='{1}'>{0}</label> <input type='text' data-dgview='edit' style='width:150px !imporant;display:none;' data-columnname='{1}' maxlength={2} value='{0}' class=\"input-text\"/>";
        ...
        public const string ManageChildHtml = "<li ><a class='{0}' {1} data-parameter='{2}'  data-managelink=\"{3}\" title='{4}' {5} ></a></li>";
        public const string TileViewManageChildHtml = "<li><a class='{0}' href=\"{1}{2}\" data-parameter='{2}'  data-managelink=\"{3}\" ><i class=\"zf-{5}\" tooltip-placement=\"top\" uib-tooltip=\"{4}\"\"></i></a></li>";
