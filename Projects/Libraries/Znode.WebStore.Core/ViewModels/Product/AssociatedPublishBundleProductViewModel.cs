...
{
    public class AssociatedPublishBundleProductViewModel : BaseViewModel
    {
        ...
        public string AssociatedProductDisplayOrder { get; set; }
        public int AssociatedProductBundleQuantity { get; set; }
    }
}
