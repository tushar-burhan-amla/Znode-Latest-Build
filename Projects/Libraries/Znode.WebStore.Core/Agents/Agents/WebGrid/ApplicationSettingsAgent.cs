...
namespace Znode.Engine.WebStore.Agents
{
    public class ApplicationSettingsAgent : BaseAgent, IApplicationSettingsAgent
    {
        ...
        public ApplicationSettingDataModel GetFilterConfigurationXML(string nameOfXML,int? userId=null) => !string.IsNullOrEmpty(nameOfXML) ? _applicationSettings.GetFilterConfigurationXML(nameOfXML) : new ApplicationSettingDataModel();

        #region XML Editor Public Methods

        //Returns  ApplicationSettingListViewModel list with filtered data
        public ApplicationSettingListViewModel ApplicationsSettingList(FilterCollection filters = null, SortCollection sortCollection = null, int? pageIndex = null, int? recordPerPage = null)
        {
            try
            {
        ...
        public List<EntityColumnModel> GetObjectColumnList(string entityType, string entityName)
        ...
        public string CreateXMLFile(List<WebGridColumnViewModel> list)
        {
        ...
        public List<WebGridColumnViewModel> GetListFromXMLString(string xmlString)
        {
        ...
        public IEnumerable<SelectListItem> GetEntityNames(string term = "", string entityType = "")
        {
            ...
            List<EntityColumnModel> entityColumnList = GetbjectName(entityType, All);
        ...
        private List<EntityColumnModel> GetbjectName(string entityType, string entityName)
        {
            List<EntityColumnModel> entityColumnList = new List<EntityColumnModel>();
            if (!string.IsNullOrEmpty(entityType) && !string.IsNullOrEmpty(entityName))
            {
