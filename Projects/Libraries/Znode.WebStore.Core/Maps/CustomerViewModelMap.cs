        ...
        public static UserModel ToAccountFromCustomerViewModel(CustomerViewModel customerViewModel)
        {
            if (HelperUtility.IsNotNull(customerViewModel))
            {
                return new UserModel()
                {
                    ...
                    Custom1 = (!Equals(customerViewModel.Custom1, null) ? HttpUtility.HtmlEncode(customerViewModel.Custom1.Trim()) : string.Empty),
                    Custom2 = (!Equals(customerViewModel.Custom2, null) ? HttpUtility.HtmlEncode(customerViewModel.Custom2.Trim()) : string.Empty),
                    Custom3 = (!Equals(customerViewModel.Custom3, null) ? HttpUtility.HtmlEncode(customerViewModel.Custom3.Trim()) : string.Empty),
