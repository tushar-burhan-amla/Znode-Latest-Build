...
namespace Znode.Engine.WebStore
{
    public static class AutocompleteHelpers
    {
            ...
            int minQueryLength, string idFieldString, bool isMultiple, bool loadOnce, object additionalViewData)
        {
            ...
            if (!string.Equals(urlControllerName, controllerName, StringComparison.InvariantCultureIgnoreCase))
            ...
            ((IDictionary<string, object>)htmlAttributes).Add("autocomplete", "off");
