...
namespace Znode.Engine.Admin.Agents
{
    public interface IApplicationSettingsAgent
    {
        ...
        Models.ViewModel CreateNewView(Models.ViewModel model);
        ...
        /// </summary>
        /// <param name="itemViewId">Item ViewId</param>
        /// <returns>boolen value </returns>
        bool DeleteView(string itemViewId);
        ...
        Models.ViewModel GetView(int itemViewId);

        /// <summary>
        /// Remove selected of all View from database.
        /// </summary>
