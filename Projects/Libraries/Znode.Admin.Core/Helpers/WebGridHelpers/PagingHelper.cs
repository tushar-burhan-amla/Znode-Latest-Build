...
namespace Znode.Engine.Admin.Helpers
{
    public static class PagingHelper
    {
        ...
        public static MvcHtmlString CustomPager(this WebGrid grid, HtmlHelper html,int totalRecordCount=0, string recordPerPageFieldName = "recordPerPage", string pageFieldName = "page", string SortFieldName = "sort", string SortDirFieldName = "sortdir")
        {
            ...
            return html.Partial("_GridPager", new GridPagerModel()
            {
                ...
                TotalRecoredCount = totalRecordCount
            });
        }
