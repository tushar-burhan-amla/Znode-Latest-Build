namespace Znode.Libraries.DevExpress.Report
{
    public struct ReportConstants
    {
        ...
        //default filter for data operator id
        ...
        public const string AffiliateOrders = "affiliateorders";
        public const string OrderPickList = "orderpicklist";
        public const string Ordertesting = "ordertesting";

        public const string EmailOptInCustomer = "emailoptincustomer";
        public const string InventoryReorder = "inventoryreorder";
        public const string MostFrequentCustomer = "mostfrequentcustomer";
        public const string PopularSearch = "popularsearch";

        public const string TopEarningProduct = "topearningproduct";
        public const string TopSpendingCustomers = "topspendingcustomers";
        public const string Users = "users";
        public const string Vendors = "vendors";
        public const string BestSellerProduct = "bestsellerproduct";
        public const string ServiceRequest = "servicerequest";
        public const string AbandonedCart = "abandonedcart";
        public const string ProcedureContainOperator = "cn";
        public const string ProcedureInOperator = "in";
