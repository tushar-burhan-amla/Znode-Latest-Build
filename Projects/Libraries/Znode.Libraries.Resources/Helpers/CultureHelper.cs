...
namespace Znode.Libraries.Resources.Helpers
{
    public static class CultureHelper
    {
        ...
        private static List<string> _cultures = new List<string> {
            ...
            "de-DE"  // German NEUTRAL culture
        };

        public static void SetConfigurationSettingSource(List<string> cultures)
        {
            _cultures = !Equals(cultures?.Count, 0) ? cultures : _cultures;
        }
