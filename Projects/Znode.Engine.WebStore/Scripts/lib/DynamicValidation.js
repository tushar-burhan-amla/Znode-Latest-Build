...
! function (t) {
    ...
    t(a).each(function () {
        ...
        "false" === t(this).attr("AllowDecimals") && "false" === t(this).attr("AllowNegative") && (t(this).attr(u, " Only natural numbers are allow in the " + t('label[for="' + this.name + '"]').html() + " field."), t(this).attr(b, "^(1|[0-9][0-9]*)$"))
    }), t(s).each(function () {
