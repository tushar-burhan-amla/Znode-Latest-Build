function showUploadPopup() {
    ...
    var header = '<div class="col-sm-12 title-container">' +
        ' <h1>MEDIA UPLOAD </h1> ' +
        '<button type="button" style="color:white;" class="btn-text-icon pull-right" onclick="EditableText.prototype.CancelUpload()"><i class="z-back"></i>BACK</button>' +
        ' </div> ';
    var popupViewModel = {
        FolderId: "1",
        DisplayMode: "Tile",
...
function reInitializationMce() {
    $("textarea[wysiwygenabledproperty=true]").each(function () {
        ...
        var tinyMceObject = {
            ...
            plugins: "advlist anchor autolink autosave link image lists charmap preview anchor pagebreak searchreplace wordcount visualblocks visualchars code codesample fullscreen insertdatetime media nonbreaking quickbars table directionality emoticons template help save",
            content_css: [
                "/Scripts/tinymce/skins/content/default/content.css",
            ],
            menubar: 'file edit view insert format tools table help',
            toolbar: "insertfile undo redo | fullscreen | blocks | styleselect formatselect fontselect fontsizeselect | bold italic underline strikethrough  | alignleft aligncenter alignright alignjustify | bullist numlist outdent indent blockquote | link unlink anchor image cleanup code | print preview media fullpage| insertdate inserttime | forecolor backcolor emoticons | tablecontrols | hr removeformat | sub sup | charmap advhr | ltr rtl",
            toolbar_mode: 'wrap',
