                        ...
                        '<div class="modal-dialog modal-md" role="document">' +
                            '<div class="modal-content">' +
                                ...
                                '<div class="modal-footer">' +
                                    '<div class="pull-right"><button type="button" class="' + this.proceedButtonClass + ' btn-text" data-dismiss="modal"></button>' +
                                    '<button type="button" class="' + this.stayButtonClass + ' btn-text" data-dismiss="modal"></button></div>' +
                                '</div>' +
                            '</div>' +
                        '</div>' +
                    '</div>');
