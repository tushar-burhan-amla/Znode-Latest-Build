        ...
        createDropdown: function () {
            ...
            var header = this.options.header ?
                ...
                donebutton = this.multiple && this.options.doneButton ?
                    ...
                    '</div>' : '',
                drop =
                    '<div class="btn-group bootstrap-select page-select-dropdown' + multiple + inputGroup + '">' +
        ...
        createLi: function () {
            ...
            this.$element.find('option').each(function (index) {
                ...
                if ($this.data('thumbnail')) {
                    ...
                    text =
                        '<span class="media">' +
                    '<span class="media-left"><img src="' + $this.data('thumbnail') + '" class="media-object dropdown-Image" onerror="src=\'data:image/gif;base64,R0lGODlhAQABAIAAAAAAAP///yH5BAEAAAAALAAAAAABAAEAAAIBRAA7\'"></span>' +
