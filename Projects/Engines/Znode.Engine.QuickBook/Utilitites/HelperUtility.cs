...
namespace Znode.Engine.QuickBook
{
    internal class HelperUtility
    {
        ...
        /// <returns>Quickbook Xml String</returns>
        /// <example>GetQuickBookXML<ItemQueryRq>(itemQueryRq, "ItemQueryRq")</example>
        public static string GetQuickBookXML<T>(T t, string typeName) where T : class
        {
            try
            {
        ...
        ? (QuickBookConstants.DefaultCustomerName)
        : (orderModel?.UserName);
        ...
        /// <summary>
        /// Decorated XML document with required QuickBook XML format
        /// </summary>
        ...
        /// </summary>
        /// <returns>XmlDocument with require QuickBook header element</returns>
