...
namespace Znode.Engine.QuickBook
{
    public class CustomerQBXML : IDisposable
    {
        ...
        => HelperUtility.GetQuickBookXML<CustomerAddRq>
          (customerAddRq, QuickBookConstants.CustomerAddRqXMLAttribute);
        ...
        /// <summary>
        /// Implementation of IDisposible interface
        /// </summary>
        ...
        /// <summary>
        /// Mapping of customer model used in QuickBook response XML string generation from znode order model for creating new customer if it's not available in QuickBook
        /// </summary>
        /// <param name="orderModel">order model available in ZNode</param>
        /// <returns>customer model used in QuickBook response XML string</returns>
        ...
        /// <summary>
        /// Mapping of address model used in QuickBook response XML string generation from znode order model for creating new billing address if it's not available in QuickBook
        /// </summary>
        /// <param name="orderModel">order model available in ZNode</param>
        /// <returns>Address model used in QuickBook response XML string</returns>
