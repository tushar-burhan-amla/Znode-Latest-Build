...
namespace Znode.Engine.QuickBook
{
    public class SalesOrderQBXML : IDisposable
    {
        ...
        => HelperUtility.GetQuickBookXML<SalesOrderAddRq>
        (salesOrderAddRq, QuickBookConstants.SalesOrderAddRqXMLAttribute);
        ...
        /// <summary>
        /// Maps object from znode order model to QuickBook SalesOrderAdd Request model
        /// </summary>
        ...
        /// <returns>Mapped QuickBook SalesOrderAdd Request model</returns>
        ...
        /// <summary>
        /// Maps object from znode order model to QuickBook SalesOrderAdd model
        /// </summary>
        /// <param name="orderModel">znode order model from which order mapping needs to be done</param>
        /// <returns>Mapped QuickBook SalesOrderAdd Request model</returns>
        ...
        => new SalesOrderAdd()
        {
            ...
            TxnDate = orderModel.OrderDate.ToString(QuickBookConstants.DateFormat),
            Memo = QuickBookConstants.DefaultNAText
        };

        /// <summary>
        /// Maps object from znode order model to QuickBook shipping address model
        /// </summary>
        /// <param name="orderModel">znode order model from which order mapping needs to be done</param>
        /// <returns>Mapped QuickBook shipping address model</returns>
        ...
        /// <summary>
        /// Gives reference type for mapping customer with sales order within QuickBook from ZNode Order model
        /// </summary>
        /// <param name="orderModel">znode order model from which order mapping needs to be done</param>
        ...
        /// <summary>
        /// Maps object from znode order model to QuickBook billing address model
        /// </summary>
        /// <param name="orderModel">znode order model from which order mapping needs to be done</param>
        /// <returns>Mapped QuickBook billing address model</returns>
        ...
        /// <summary>
        /// Gets reference number to be set in QuickBook from ZNode order model
        /// </summary>
        /// <param name="orderModel">znode order model from which order mapping needs to be done</param>
        /// <returns>Reference number to be set in QuickBook</returns>
