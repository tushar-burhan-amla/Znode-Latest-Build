namespace Znode.Engine.Api.Client.Expands
{
    public static class ExpandKeys
    {
        public static string AddOns { get; } = "addons";
        public static string Addresses { get; } = "addresses";
        public static string Categories { get; } = "categories";
        public static string Facets { get; } = "facets";
        public static string GiftCardHistory { get; } = "giftcardhistory";
        ...
        public static string Reviews { get; } = "reviews";
        public static string Skus { get; } = "skus";
        public static string Tiers { get; } = "tiers";
        ...
        public static string GroupLocale { get; } = "grouplocale";
        ...
        public static string SEO { get; } = "seo";
        ...
        public static string ConfigurableAttribute { get; } = "configurableattribute";
        ...
        public static string ZnodeSearchProfile { get; } = "znodesearchprofile";
        public static string AssociatedProducts { get; } = "AssociatedProducts";
        public static string IsFromReOrder { get; } = "isfromreorder";
        public static string Swatch_AttributeCode { get; } = "swatch_";
        public static string WishlistAddOns { get; } = "wishlistaddons";
