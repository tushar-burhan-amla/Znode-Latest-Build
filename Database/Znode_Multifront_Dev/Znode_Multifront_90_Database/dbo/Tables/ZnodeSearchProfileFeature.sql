CREATE TABLE [dbo].[ZnodeSearchProfileFeature] (
    [SearchProfileFeatureId] INT             IDENTITY (1, 1) NOT NULL,
    ...
    CONSTRAINT [PK_ZnodeSearchFeture] PRIMARY KEY CLUSTERED ([SearchProfileFeatureId] ASC)
);
