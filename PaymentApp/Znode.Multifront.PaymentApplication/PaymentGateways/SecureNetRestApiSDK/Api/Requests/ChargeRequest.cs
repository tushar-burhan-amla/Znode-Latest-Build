...
namespace SecureNetRestApiSDK.Api.Requests
{
    ...
    /// </summary>
    public class ChargeRequest : SecureNetRequest
    {
        #region Properties
        ...
        /// <summary>
        /// Additional data to assist in reporting, ecommerce or Mail Order/Telephone Order transactions, and level 2 or level 3 processing. Includes user-defined fields and invoice-related information.
        /// </summary>
